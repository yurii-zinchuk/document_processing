...
import com.zinchuk.scandoc.data.workers.ProcessingWorker
import com.zinchuk.scandoc.data.workers.ProcessingWorker.Companion.wrapWorkData
...
class DocumentSetsRepositoryImpl
    @Inject
    constructor(
