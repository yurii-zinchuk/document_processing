...
import com.zinchuk.scandoc.domain.usecases.CreateDocumentSetUseCase
import com.zinchuk.scandoc.domain.usecases.DeleteDocumentSetUseCase
import com.zinchuk.scandoc.domain.usecases.GetAllDocumentSetsUseCase
...
class MainScreenVM
    ...
    constructor(
        ...
        fun onDeleteDocumentSet(uuid: UUID) =
            viewModelScope.launch {
                deleteDocumentSetUseCase.execute(uuid)
            }

        fun onCreateDocumentSet(name: String) =
